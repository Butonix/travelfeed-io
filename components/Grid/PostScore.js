    ...
    <>
      ...
      >
        <IconButton size="small" color="primary" onClick={() => setOpen(true)}>
          <VoteButton
            weight={calculateQualityScore([data.postCurationScores])}
            size="24"
          />
        </IconButton>
      </Tooltip>
      ...
      >
        ...
        <DialogContent>
          <DialogContentText>
            {data &&
            Object.values(data.postCurationScores).indexOf(true) === -1 ? (
              'We love your post! Keep up the great work :)'
            ) : (
              <ul>
                {data.postCurationScores.notTf ? (
                  <li>
                ...
                {data.postCurationScores.formatting ? (
                  <li>
                ...
                {data.postCurationScores.bilingual ? (
                  <li>
                ...
                {data.postCurationScores.photos ? (
                  <li>
                ...
                {data.postCurationScores.writing ? (
                  <li>
                ...
                {data.postCurationScores.language ? (
                  <li>
                ...
                {data.postCurationScores.footer ? (
                  <li>
                ...
                {data.postCurationScores.valueadding ? (
                  <li>
                ...
                {data.postCurationScores.location ? (
                  <li>
