...
const Privacy = () => {
  return (
    <Fragment>
      ...
      <b>TravelFeed</b>
      <p>
        This Privacy Policy describes how TravelFeed, collectively referred to
        as &quot;TravelFeed&quot; (or &quot;we&quot; or &quot;us&quot; or
        &quot;our&quot;) collects, uses, and handles your data when you use our
        website, products, dApp and services (&quot;services&quot;). Please take
      ...
      <p>
        ...
        you choose to save personal information on the Blockchain, these will be
        retained on the blockchain forever and cannot be deleted, but you may
        choose to edit them in order to hide them on TravelFeed.
      </p>
      ...
      <p>
        ...
        (e.g. a username, an email address, phone number), account preferences,
        and the content of information you post to the services (e.g. text,
        photos, videos, links).
      </p>
      <Typography gutterBottom variant="h6">
      ...
      <p>
        ...
        cookies read our <a href="/about/cookies">cookie policy</a>.
      </p>
      ...
      <p>
        Please note that, deleting content from the blockchain is technically
        impossible, but you can edit your posts and delete the content to hide
        them on major frontends. If you want us to blacklist all your content on
        TravelFeed at once, you can write us an email and request to have your
        account blacklisted. If you would like to make use of your right to data
      ...
      <p>
        ...
        as our analytics partners to help analyze usage and traffic for our
        services. As an example, we may use Matomo&#39;s services to analyze and
      ...
      <p>
        All Matomo data is stored on our server in the EU. Via their services we
        give you several options on how to handle your data, please make use of
        the consent request when you use our services. Please be aware that we
        store a cookie on your device to remember your consent choices.
      </p>
      <Typography gutterBottom variant="h5">
        13. Security
      </Typography>
      ...
      <p>
        TravelFeed does not receive or store your Account password, or the
        unencrypted keys and addresses. TravelFeed uses SteemConnect
        authentication. In order to delete your connection with TravelFeed,
        please visit your{' '}
        <a
          href="https://beta.steemconnect.com/revoke/travelfeed.app"
          rel="noopener noreferrer nofollow"
          target="_blank"
        >
          SteemConnect dashboard
        </a>{' '}
        and revoke the authentication of TravelFeed. Please note, however, that
        the posts, comments, and messages you submitted prior to deleting your
        account will still be visible to others, unless you edit such content to
        hide it. We may also retain certain information about you as required by
        law or for legitimate business purposes after you delete your account.
        Any information that has been published to the Steem blockchain will
        remain indefinitely.
      </p>
      <Typography gutterBottom variant="h6">
        15.3. Cookies
      ...
      <p>
        ...
        <a href="/about/cookies">cookie policy</a> section.
      </p>
      <Typography gutterBottom variant="h6">
      ...
      <p>
        ...
        allow you to better understand cookies and how you can opt-out. You have
        the ability to opt out of having your web browsing information used for
        behavioral advertising purposes. You can choose to{' '}
      ...
      <p>
        ...
        advertising purposes, as described above. DNT is one of the consent
        options via the the Matomo services.
      </p>
      <Typography gutterBottom variant="h6">
      ...
      <p>
        We use a self-hosted insance of{' '}
        <a
        ...
        to analyze information on visitors to our website. This will help us to
        improve our services, streamline the user interface and using data
        collected for marketing purposes. You can find more information on their
        services{' '}
        <a
      ...
      <p>
        ...
        information on the privacy practices of Cloudlfare, please visit the{' '}
        <a
      ...
      <p>
        We allow our users to embed media from the following websites and
        service
      </p>
      ...
      <p>
        TravelFeed will store the majority of content on the Steem Blockchain.
      </p>

      <p>
        TravelFeed has no ability to remove content from Steem or affect access
        by any other third party to any content stored on the Steem Blockchain.
        The reason being that transactions sent to the Steem blockchain are not
        stored on TravelFeed nor does TravelFeed have any ability to modify or
        delete what is on the Steem Blockchain. Additionally, no third party has
        the technical or effectual ability to modify or delete content found on
        the Steem Blockchain, but everyone has the ability to display the
        content in question.
      </p>
      <Typography gutterBottom variant="h5">
        19. Changes
